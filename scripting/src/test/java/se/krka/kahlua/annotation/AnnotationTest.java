...
public class AnnotationTest {
	...
	public void testNotEnoughParameters() throws IOException {
		...
		try {
			...
			assertEquals("Expected 2 arguments but got 1. Correct syntax: obj:inheritedMethodWithArgs(zomg, imba)", e.getMessage());
		}
	}
	...
	public void testGlobalFunctionWrongNumberOfParams() throws IOException {
		...
		try {
			...
			assertEquals("Expected 4 arguments but got 1. Correct syntax: myGlobalFunction(s, d, b, i)", e.getMessage());
		}
	}
